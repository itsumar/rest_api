...
|
*/
// $config['base_url'] = 'http://localhost/malaeb-ole/';
...
$config['base_url']  =  $site_url; //"https://sandbox.malaeb-ole.ae/";
...
|
*/
$config['permitted_uri_chars'] = 'a-zA-Z 0-9~%.:_\-@=+'; //'a-z 0-9~%.:\_\=+%\&'; //'a-z 0-9~%.:_\-';
...
|
*/
$config['encryption_key'] = 'asa$@&&&$$114221ldw541*mklsa';
